...
client.on("interactionCreate", async (interaction) => {
  ...
  if (interaction.commandName === "help") {
    const helpText = [
      ...
      `> \`/trade your_offer: Nocturne, Scarwing their_offer: Evangeline\``,
      ``,
      ...
      `🔢 **QUANTITY FORMATS**`,
      `━━━━━━━━━━━━━━━━━━━━━━━━`,
      `> \`2 Nocturne\` — number before name`,
      `> \`3x Scarwing\` — Nx before name`,
      `> \`Evangeline x2\` — xN after name`,
      ``,
      `━━━━━━━━━━━━━━━━━━━━━━━━`,
      `🔍 **FLEXIBLE NAMES**`,
      `━━━━━━━━━━━━━━━━━━━━━━━━`,
      ...
      `• High demand items get +10% adjusted value`,
      `• Low demand items get -10% adjusted value`,
